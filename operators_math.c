...
/**
 *  * op_add - add first 2 elements of the stack
...
/**
 *  * op_sub - subtract 2 elements of the stack
 *   * @head: pointer to pointer to first node
 *    * @counter: line counter
 *     *
 *      * Return: none
...
/**
 *  * op_mul - multiply first 2 elements of the stack
 *   * @head: pointer to pointer to first node
 *    * @counter: line counter
 *     *
 *      * Return: none
...
/**
 *  * op_div - divide first 2 elements of the stack
 *   * @head: pointer to pointer to first node
 *    * @counter: line counter
 *     *
 *      * Return: none
...
/**
 *  * op_mod - compute modulos of two elements in stack
 *   * @head: pointer to pointer to first node
 *    * @counter: line counter
 *     *
 *      * Return: none
